...
}`;function S(){const t=navigator.userAgent.toLowerCase();return t.includes("safari")&&!t.includes("chrome")&&!t.includes("android")}function C(t){const e=visualViewport?.scale??1,i=visualViewport?.width??window.innerWidth,o=window.innerWidth-t.documentElement.clientWidth,r=e*i+o,s=outerWidth/r,a=Math.round(100*s);return a%5===0?a/100:a===33?1/3:a===67?2/3:a===133?4/3:s}const P={fit:"contain",scale:1,rotation:0,offsetX:0,offsetY:0,originX:.5,originY:.5,worldWidth:0,worldHeight:0},H={none:0,contain:1,cover:2},R=`
...
`,v={maxColorCount:7},z=`#version 300 es
